                            ...
                            <div class="single-pro-cart">
                                    <div class="single-shipping-botton">
										...
										<?php if ($row['status'] == 1) { echo
											'<br><button type="button" data-toggle="modal" data-target="#terimapesananmasuk'.$id_pesanan.'""> 
                                                <span>Terima Pesanan</span>
                                            </button>
											<br><button type="button" data-toggle="modal" data-target="#tolakpesananmasuk'.$id_pesanan.'"">
                                                <span>Tolak Pesanan</span>
                                            </button>
											<br><button type="button" data-toggle="modal" data-target="#hapuspesananmasuk'.$id_pesanan.'"">
                                                <span>Hapus Pesanan</span>
                                            </button>';
											}
											if(($row['status'] == 2) || ($row['status'] == 3)){
											echo '
											<button type="button" data-toggle="modal" data-target="#hapuspesananmasuk'.$id_pesanan.'"">
                                                <span>Hapus Pesanan</span>
                                            </button>';
											}
											?>
																	...
																	<div class="modal-dialog">
																		<div class="main-view modal-content">
																			...
																			<div class="section-title text-center mb-70">
																				<h2>Apakah Anda Yakin Ingin Menerima Pesanan Masuk Ini ?</h2>
																			</div>
																			<div class="single-shipping-botton">
																			...
																			<br>
																			<button type="button" onclick="location.href='<?php echo "lihatpesananmasuk.php?user="; echo $username; echo "&role="; echo $role;  echo "&id="; echo $row['id']; ?>';"> 
