...
if(isset($_POST["id"]) && !empty($_POST["id"])){
	...
	$sql = "SELECT * FROM item WHERE id=$id AND kode = '".$username."'";
	$result = mysqli_query($link, $sql);
	$row = mysqli_fetch_assoc($result);
	
	if(empty($new_filename[0])){
	$new_filename[0] = $row['photo'];
	} 
	
	if(empty($new_filename[1])){
	$new_filename[1] = $row['photo2'];
	}
	
	if(empty($new_filename[2])){
	$new_filename[2] = $row['photo3'];
	}
	
	if(empty($new_filename[3])){
	$new_filename[3] = $row['photo4'];
	}	
    ...
    if(empty($nama_err) && empty($alamat_err) && empty($harga_err) && empty($jenis_err) && empty($photo_errors)){
        ...
        $sql = "UPDATE item SET nama=?, alamat=?, harga=?, satuan=?, deskripsi=?, jenis=?, kategori=?, wilayah=?, fasilitas=?, photo=?, photo2=?, photo3=?, photo4=?, kode=?, lat=?, lng=? WHERE id=?";
		
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssssssssssssssi", $param_nama, $param_alamat, $param_harga, $param_satuan_harga, $deskripsi, $jenis, $kategori, $wilayah, $fasilitas, $new_filename[0], $new_filename[1], $new_filename[2], $new_filename[3], $kode, $lat, $lng, $id);
...
if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
        ...
        $sql = "SELECT * FROM item WHERE id = ? AND kode = '".$username."'";
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
...
$jenisnya = explode(',',$row['jenis']);
$kategorinya = explode(',',$row['kategori']);;
$wilayahnya = explode(',',$row['wilayah']);;
$fasilitasnya = explode(',',$row['fasilitas']);; 
		...
		<div class="breadcrumbs-area breadcrumb-bg ptb-100">
		    <div class="container">
		        <div class="breadcrumbs text-center">
                    <h2 class="breadcrumb-title">Ubah Data</h2>
		                        ...
		                        <div class="row">
									...
									<div class="col-md-12">
                                        <div>
											...
											<br>
											<img id="output1" alt="Gambar 1..." height="150px" width="200px" src="<?php echo "../upload/"; echo $row['photo'];?>">
									...
									<div class="col-md-12">
                                        <div>
											...
											<br>
											<img id="output2" alt="Gambar 2..." height="150px" width="200px" src="<?php echo "../upload/"; echo $row['photo2'];?>">
									...
									<div class="col-md-12">
                                        <div>
											...
											<br>
											<img id="output3" alt="Gambar 3..." height="150px" width="200px" src="<?php echo "../upload/"; echo $row['photo3'];?>">
									...
									<div class="col-md-12">
                                        <div>
											...
											<br>
											<img id="output4" alt="Gambar 4..." height="150px" width="200px" src="<?php echo "../upload/"; echo $row['photo4'];?>">
