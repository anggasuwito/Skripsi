...
if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
	...
	$sqla = "SELECT * FROM pesanan WHERE id_item ='".$param_id."' AND nama_pemesan ='".$username."'";
                    ...
                    <div class="col-md-7">
                        <div class="single-product-content">
                            ...
                            <div class="single-pro-cart">
									...
									<input type="hidden" name="id_item" value="<?php echo $param_id; ?>">
									<input type="hidden" name="status" value="1">
									<input type="hidden" name="nama_pemesan" value="<?php echo $username; ?>">
									<input type="hidden" name="nama_penyedia" value="<?php echo $row['kode']; ?>">
                                            <br>
											<?php if(mysqli_num_rows($resulta) > 0){ 
											echo '<button type="button" onclick="location.href=\'statuspenyedia.php?user='.$username.'&role='.$role.' \'";
											<a style="color:white">Telah terpesan. Klik untuk melihat pesanan</a>
                                            </button>';} else { 
