		...
		<div class="breadcrumbs-area breadcrumb-bg ptb-100">
		    <div class="container">
		        <div class="breadcrumbs text-center">
                    <h2 class="breadcrumb-title">Tutorial Penyedia</h2>
		        ...
		        <div class="row">
		            <div class="col-md-12">
		                <div class="about-all">
							...
							<p>3. Username dan password yang dibuat sebelumnya dapat digunakan untuk mengakses website dengan fitur yang ditentukan dalam sesi pencari maupun penyedia. Pilih masuk sebagai <b>Penyedia</b> untuk masuk sebagai penyedia layanan kos maupun kontrakan yang ada di Manado.</p>
							<img src="tutorial/4aa.jpg" alt="">
							<p>4. Setelah anda masuk pada website sebagai penyedia layanan kos dan kontrakan, anda akan menuju ke halaman awal penyedia dimana anda dapat menambah, mengubah, bahkan menghapus data maupun pesanan yang masuk dari pengguna yang mencari layanan penyedia. Anda juga dapat melihat profil pencari pada bagian status pesanan masuk pada halaman ini.</p>
							<img src="tutorial/9aa.jpg" alt="">
							<img src="tutorial/10aa.jpg" alt="">
							<p>5. Pilih <b>tambah data</b> untuk menambah data kos atau kontrakan. Kemudian isi form-form yang tersedia dengan lengkap. Data yang berhasil dibuat akan disimpan dihalaman awal penyedia.</p>
							<img src="tutorial/11aa.jpg" alt="">
							<img src="tutorial/12aa.jpg" alt="">
							<img src="tutorial/13aa.jpg" alt="">
							
							<p>6. Sebelum menutup browser, pilih <b>keluar</b> untuk keluar dari akun anda.</p>
