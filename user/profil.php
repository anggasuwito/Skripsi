			                ...
			                <div class="cart-menu">
                                ...
                                <div class="user user-style-3 f-right">
						            <a>
                                       ...
                                       <?php echo "Hi, ";echo $usernama; echo " anda masuk sebagai "; echo ($_GET['role']); 
                        ...
                        <div class="login-content">
                            ...
                            <div class="login-form">
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
									<img src="../uploadfotoprofil/<?php if(empty($rowz['fotoprofil'])) { echo "default.jpg";} else { echo $rowz['fotoprofil']; }?>" height="100px" width="100px" alt="">
									...
									<input name="name" readonly placeholder="Nama Lengkap" type="text" class="form-control" value="<?php echo $alamat; ?>" ><span class="help-block">Telepon :</span>
                                    ...
                                    <div class="new-account">
                                        <p>Pilih disini untuk mengganti profil <a href="gantiprofil.php?user=<?php echo $usernama; echo "&role="; echo $role; ?>" style="color:blue">Ganti Profil</a></p>
                                    </div><div class="new-account">
                                        <p>Pilih disini untuk mengganti password <a href="gantipassword.php?user=<?php echo $usernama; echo "&role="; echo $role; ?>" style="color:blue">Ganti Password</a></p>
                                    </div>	
                                    <div class="button-remember">
                                        <button class="login-btn" type="button" onclick="location.href='<?php if($role == "pencari"){ echo "index.php?user="; echo $usernama; echo "&role="; echo $role; } if($role == "penyedia"){ echo "statuspenyedia.php?user="; echo $usernama; echo "&role="; echo $role; } ?>';">Kembali</button>
                                    </div>
