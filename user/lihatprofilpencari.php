			    ...
			    <div class="container">
			        <div class="row">
			            <div class="col-md-4 col-sm-3 col-xs-6">
			                <div class="logo">
			                    <a href="<?php echo "statuspenyedia.php?user="; echo $usernama; echo "&role="; echo $role; ?>">
                                    ...
                                    <div class="currence-user-page">
                                        <div class="user-page">
                                            <ul>
                                               ...
                                               <li><a href="<?php echo "statuspenyedia.php?user="; echo $usernama; echo "&role="; echo $role; ?>"><i class="pe-7s-info"></i> Lihat Status</a></li>
