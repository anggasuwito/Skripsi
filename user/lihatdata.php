                        ...
                        <div class="single-product-content">
                            ...
                            <div class="single-pro-cart">
                                    <div class="single-shipping-botton">
									        <br><button type="button" onclick="location.href='<?php echo "ubahdata.php?user="; echo $username; echo "&role="; echo $role;  echo "&id="; echo $row['id']; ?>';"> 
                                                <span>Ubah</span>
                                            </button>
											<br><button type="button" data-toggle="modal" data-target="#hapusdata<?php echo $row['id'];?>"> 
                                                <span>Hapus</span>
                                            </button>
																...
																<div class="d-tablecell">
																	<div class="modal-dialog">
																		<div class="main-view modal-content">
																			...
																			<br>
																			<button type="button" onclick="location.href='<?php echo "lihatdata.php?user="; echo $username; echo "&role="; echo $role;  echo "&id="; echo $row['id']; ?>';"> 
