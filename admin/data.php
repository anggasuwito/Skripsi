...
if(empty($fasilitasnya)){ $fasilitasnya = ""; }
										...
										<tr>
											...
											<td class="actions text center" >	
												...
												<a href="#" class="on-default remove-row" data-toggle="modal" data-target="#hapusdata<?php echo $row['id']; ?>"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
																...
																<div class="d-tablecell">
																	<div class="modal-dialog">
																		<div class="main-view modal-content">
																			...
																			<button type="button" onclick="location.href='<?php echo "hapusdata.php?id="; echo $row['id']; ?>';"> 
