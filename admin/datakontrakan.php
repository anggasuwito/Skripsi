								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									<thead>
										<tr>
											...
											<th class="text center">Nama Kontrakan</th>
									...
									<?php	
										...
										$sql= 'SELECT * FROM item WHERE jenis = 12';	
...
if(empty($fasilitasnya)){ $fasilitasnya = ""; }
										...
										<tr>
											...
											<td class="actions text center" >	
												...
												<a href="#" class="on-default remove-row" data-toggle="modal" data-target="#hapusdatakontrakan<?php echo $row['id']; ?>"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
									<div class="quick-view modal fade in" id="hapusdatakontrakan<?php echo $row['id']; ?>">
											<div class="container">
												<div class="row">
													<div id="view-gallery">
														<div class="col-xs-12">
																...
																<div class="d-tablecell">
																	<div class="modal-dialog">
																		<div class="main-view modal-content">
																			...
																			<button type="button" onclick="location.href='<?php echo "hapusdata.php?idkontrakan="; echo $row['id']; ?>';"> 
